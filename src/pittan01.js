							...
							return function (newWordsAt) {
								return function (foundWords) {
									return function (completed) {
										return {board: board, candidates: candidates, completed: completed, conf: conf, cursor: cursor, foundWords: foundWords, moving: moving, newWordsAt: newWordsAt, nowAt: nowAt, startedAt: startedAt};
									};
								};
							};
						};
